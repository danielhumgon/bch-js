...
class BitcoinCash {
  ...
  /**
   * @api BitcoinCash.toSatoshi() Converting Bitcoin Cash units to satoshi units.
   * @apiName toSatoshi
  ...
  /**
   * @api BitcoinCash.toBitcoinCash() Converting satoshi units to Bitcoin Cash units.
  ...
  /**
   * @api BitcoinCash.toBits() Converting satoshi units to Bits denomination.
   * @apiName toBits
   * @apiGroup BitcoinCash
   * @apiDescription
  ...
  /**
   * @api BitcoinCash.signMessageWithPrivKey() Sign message with private key.
  ...
  /**
   * @api BitcoinCash.verifyMessage() Verify message.
  ...
  /**
   * @api BitcoinCash.encodeBase58Check() Encodes hex string as base58Check.
  ...
  /**
   * @api BitcoinCash.decodeBase58Check() Decodes base58Check encoded string to hex.
  ...
  /**
   * @api BitcoinCash.encodeBIP21() Encodes address and options as BIP21 uri.
   * @apiName encodeBIP21
   * @apiGroup BitcoinCash
   * @apiDescription
  ...
  /**
   * @api BitcoinCash.decodeBIP21() Decodes BIP21 uri.
   * @apiName decodeBIP21
   * @apiGroup BitcoinCash
   * @apiDescription
   * Decodes BIP21 uri.
  ...
  /**
   * @api BitcoinCash.getByteCount() Get byte count of transaction.
  ...
  /**
   * @api BitcoinCash.encryptBIP38() BIP38 encrypt privkey WIFs.
  ...
  /**
   * @api BitcoinCash.decryptBIP38() BIP38 encrypt privkey WIFs.
