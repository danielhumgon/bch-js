...
class Crypto {
  /**
   * @api Crypto.sha256() Utility for creating sha256 hash.
   * @apiName sha256
   * @apiGroup Crypto
  ...
  /**
   * @api Crypto.ripemd160() Utility for creating ripemd160 hash.
   * @apiName ripemd160
   * @apiGroup Crypto
  ...
  /**
   * @api Crypto.hash256() Utility for creating double sha256 hash.
   * @apiName hash256
   * @apiGroup Crypto
  ...
  /**
   * @api Crypto.hash160() Utility for creating ripemd160(sha256()) hash.
   * @apiName hash160
   * @apiGroup Crypto
  ...
  /**
   * @api Crypto.randomBytes() Generates cryptographically strong pseudo-random data.
   * @apiName randomBytes
   * @apiGroup Crypto
