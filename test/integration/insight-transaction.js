...
describe(`#Transaction`, () => {
  describe(`#details`, () => {
    it(`should GET details for a given txid`, async () => {
      ...
      const result = await bchjs.Insight.Transaction.details(txid)
    ...
    it(`should GET details for an array of txids`, async () => {
      ...
      const result = await bchjs.Insight.Transaction.details(txids)
      //console.log(`result: ${JSON.stringify(result, null, 2)}`)
    ...
    it(`should throw an error for improper single input`, async () => {
      try {
        ...
        await bchjs.Insight.Transaction.details(txid)
    ...
    it(`should throw error on array size rate limit`, async () => {
      try {
        ...
        const result = await bchjs.Insight.Transaction.details(data)
